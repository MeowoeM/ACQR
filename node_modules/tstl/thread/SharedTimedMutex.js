...
var SharedTimedMutex = /** @class */ (function () {
    ...
    SharedTimedMutex.prototype.try_lock_for = function (ms) {
        ...
        return new Promise(function (resolve) {
            ...
            var it = _this.queue_.insert(_this.queue_.end(), resolver);
            if (resolver.handler === null)
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this._Current_access_type() !== 0 /* WRITE */)
                    throw new InvalidArgument_1.InvalidArgument("Bug on std." + this.source_.constructor.name + ".unlock(): this mutex is free on the unique lock.");
                --this.writing_;
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this._Current_access_type() !== 1 /* READ */)
                    throw new InvalidArgument_1.InvalidArgument("Bug on std." + this.source_.constructor.name + ".unlock_shared(): this mutex is free on the shared lock.");
                --this.reading_;
                this.queue_.pop_front();
                this._Release();
                return [2 /*return*/];
    ...
    SharedTimedMutex.prototype._Release = function () {
        ...
        try {
            for (var _b = __values(this.queue_), _c = _b.next(); !_c.done; _c = _b.next()) {
