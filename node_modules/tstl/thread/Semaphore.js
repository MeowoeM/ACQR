    ...
    Semaphore.prototype.release = function (count) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                // VALIDATE COUNT
                if (count < 1)
                    throw new OutOfRange_1.OutOfRange("Bug on std.Semaphore.release(): parametric count is less than 1 -> (count = " + count + ").");
                else if (count > this.max_)
                    throw new OutOfRange_1.OutOfRange("Bug on std.Semaphore.release(): parametric count is greater than max -> (count = " + count + ", max = " + this.max_ + ").");
                else if (count > this.acquiring_)
                    throw new OutOfRange_1.OutOfRange("Bug on std.Semaphore.release(): parametric count is greater than acquiring -> (count = " + count + ", acquiring = " + this.acquiring_ + ").");
                // DO RELEASE
